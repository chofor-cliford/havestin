...
import { Accountnames, AccountsNameContainers, AccountsWrappers, AccountNames, ProfileContainer, ProfileWrapper, ProfileCategoryContainer, ShowVideo, NotShowVideo, Categoryspacing, VideoListContainer } from './styles';
    ...
    <ProfileContainer>
      ...
      <ProfileCategoryContainer>
        ...
        {showUserVideos ? (
          ...
          <NotShowVideo onClick={() => setShowUserVideos(true)}>Video</NotShowVideo>
        )}
        {!showUserVideos ? (
          <ShowVideo onClick={() => setShowUserVideos(false)}>Liked</ShowVideo>
        ):(
          <NotShowVideo onClick={() => setShowUserVideos(false)}>Liked</NotShowVideo>
        )}
        </Categoryspacing>
        </ProfileCategoryContainer>
          <VideoListContainer>
