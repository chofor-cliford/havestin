...
import { AccountRight, PostedCommentContainer, PostedCommentWrapper } from '../../components/Comments/styles';
import NoResults from '../../components/NoResults/NoResults';
import { Accountname, AccountsContainer, AccountsNameContainer, AccountsWrapper } from '../../components/SuggestedAccounts/styles';
import VideoCard from '../../components/VideoCard/VideoCard';
import useAuthStore from '../../store/authStore';
import { IUser, Video } from '../../types';
import { BASE_URL } from '../../utils';
import { AccountNames, NotShowVideo, ProfileCategoryContainer, ShowVideo } from '../profile/styles';
import { CategorySpacing, SearchAccountsContainer, SearchContainer, SearchVideosContainer } from './styles';
  ...
  return (
    <SearchContainer>
        <ProfileCategoryContainer>
            ...
            <NotShowVideo onClick={() => setIsAccounts(true)}>Accounts</NotShowVideo>
            )}
            {!isAccounts ? (
            <ShowVideo onClick={() => setIsAccounts(false)}>Videos</ShowVideo>
            ):(
            <NotShowVideo onClick={() => setIsAccounts(false)}>Videos</NotShowVideo>
            )}
            </CategorySpacing>
        </ProfileCategoryContainer>
        {isAccounts ? (
